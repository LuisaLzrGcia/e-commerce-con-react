...
function LoginView({ handledLoginSubmit }) {
  ...
  return (
    <>
      <div className="flex items-center justify-center w-screen h-2/3 top-80 absolute">
        <div className="flex p-5 w-auto justify-center flex-col items-center bg-slate-200 rounded-lg shadow-xl border">
